...
/* package Estate-ledger-0.1.0.0 */
#ifndef VERSION_Estate_ledger
#define VERSION_Estate_ledger "0.1.0.0"
#endif /* VERSION_Estate_ledger */
#ifndef MIN_VERSION_Estate_ledger
#define MIN_VERSION_Estate_ledger(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Estate_ledger */
...
#define CURRENT_COMPONENT_ID "Estate-ledger-0.1.0.0-inplace-Estate-ledger"
